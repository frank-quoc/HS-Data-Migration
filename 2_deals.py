...
# API BATCH deals and JSON information
url = "https://api.hubapi.com/crm/v3/objects/deals/batch/create?hapikey=HS_API_KEY"
headers = {'Content-Type': "application/json"}

# SQL CODE
sql_query = '''SELECT * FROM frank.cleaned_deals;'''
...
if __name__ == '__main__':
    ...
    for i in range(0, len(deals), 100):
        ...
        ids = []
        ten_deals = deals[i:i+100]
        payload = {"inputs": ten_deals}
