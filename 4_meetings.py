...
# SQL Query 
sql_query = '''SELECT * FROM frank.cleaned_meetings;'''

# Path and file name to log migrations
cwd = os.getcwd()
file_name = "meetings_log.txt"
