...
url = "https://api.hubapi.com/crm/v3/associations/contact/company/batch/create?hapikey=HS_API_KEY"
headers = {'Content-Type': "application/json"}

# SQL CODE
sql_query = '''SELECT * FROM frank.contacts_companies;'''

cwd = os.getcwd()
file_name = "contacts_to_companies_log.txt"
